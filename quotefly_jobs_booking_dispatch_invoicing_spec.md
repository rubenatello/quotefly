...
- The current uncommitted candidate adds automatic, versioned new-customer follow-up schedules backed by normal Activity tasks, explicit contacted/no-response/skipped outcomes, a focused Settings editor, lifecycle cancellation and reassignment, forced-RLS tenant boundaries, and deterministic Kody attention retrieval. Its authoritative design and rollout boundary are documented in [`docs/plan/customer-follow-up-automation.md`](docs/plan/customer-follow-up-automation.md); it remains pending the exact-candidate launch gate and independent reviews.
