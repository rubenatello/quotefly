...
const intentCases = [
  ...
  ["unlabeled customer draft", "Add customer Jon Bacon 555-555-6868 jbaconzz99@yahoo.com", "DRAFT_CUSTOMER"],
  ...
  ["quote draft with component costs", "lets do a quote for Rober California for a construction job that we are building him a custom wooden table for a large dining area, cost of materials is $2000 and labor will be about $1500. Total job estimated to be about 3500", "DRAFT_QUOTE"],
  ["quote margin question", "Which quote for Rober had the highest margin?", "RANK_PROFITABLE_JOBS"],
  ["profitable customer quote question", "Show me the most profitable quote for Rober California", "RANK_PROFITABLE_JOBS"],
  ["quote material cost question", "Which quote has the highest cost for materials?", "RANK_PROFITABLE_JOBS"],
  ["quote margin need-to-know question", "I need to know which quote for Rober had the highest margin", "RANK_PROFITABLE_JOBS"],
  ["highest-margin quote need question", "Need the highest-margin quote for Rober", "RANK_PROFITABLE_JOBS"],
  ["quote cost need question", "I need the cost of quote 123", "RANK_PROFITABLE_JOBS"],
  ["quote margin report", "Prepare a report showing which quote had the highest margin", "RANK_PROFITABLE_JOBS"],
  ["quote profitability summary", "Make a summary of quote profitability", "RANK_PROFITABLE_JOBS"],
  ["most profitable quote report", "Write a report about the most profitable quote", "RANK_PROFITABLE_JOBS"],
  ["construction quote showing component costs", "Prepare a construction quote showing materials cost $2000 and labor $1500 for Rober California", "DRAFT_QUOTE"],
  ["quote showing customer cost", "Prepare a quote showing customer cost and price for Rober California", "DRAFT_QUOTE"],
  ["quote summary draft", "Make a quote summary with labor cost and customer price for Rober California", "DRAFT_QUOTE"],
  ...
  ["natural attention today", "Kody, what needs my attention today?", "PRIORITIZE_MY_DAY"],
  ["attention phrase preserves margin intent", "What needs my attention on quote margins today?", "RANK_PROFITABLE_JOBS"],
  ["attention phrase preserves pipeline intent", "What needs my attention in the pipeline today?", "SUMMARIZE_PIPELINE"],
  ["attention phrase preserves unquoted intent", "What needs my attention with customers without quotes today?", "CUSTOMERS_WITHOUT_QUOTES"],
  ...
  ["spanish prioritize assigned day", "Prioriza mi día", "PRIORITIZE_MY_DAY"],
  ["spanish list assigned tasks", "¿Qué tareas activas tengo asignadas?", "LIST_MY_ACTIVITIES"],
  ["spanish prepare activity task", "Crea una tarea de seguimiento para María mañana", "PREPARE_ACTIVITY"],
...
for (const [name, prompt] of [
  ...
  ["weather forecast", "What is the weather forecast today?"],
