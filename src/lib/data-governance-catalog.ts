...
const REVIEWED_SCHEMA_FIELD_TEXT = {
  ...
  Customer: "archivedAtUtc assignedTenantUserId createdAt deletedAtUtc email followUpStatus followUpUpdatedAtUtc fullName id lastFollowUpAttemptAtUtc lastSuccessfulContactAtUtc lifecycleVersion lostAtUtc lostByTenantUserId lostReason lostReasonNotes notes phone phoneDigits preferredLocale reopenedAtUtc tenantId updatedAt",
  FollowUpTemplate: "createdAt enabled id isDefault retiredAtUtc tenantId updatedAt version",
  FollowUpTemplateStep: "createdAt delayMinutes id notes priority stepNumber templateId tenantId title",
  CustomerFollowUpSequence: "canceledAtUtc cancellationReason completedAtUtc createdAt customerId id startedAtUtc status templateId templateVersion tenantId updatedAt",
  ...
  ActivityTask: "assignedTenantUserId canceledAtUtc completedAtUtc completedByTenantUserId createdAt createdByTenantUserId customerId deletedAtUtc dueAtUtc followUpOutcome followUpSequenceId followUpStepNumber id notes origin priority quoteId sourceKey status tenantId title type updatedAt version",
  ActivityTaskEvent: "activityTaskId actorKind actorTenantUserId commandKeyHash commandPayloadHash createdAt fromStatus id requestId tenantId toStatus type",
  ...
  QuickBooksTaxEstimateOperation: "attemptCount attemptTokenHash bindingKeyId canonicalAtUtc canonicalEstimateHash claimExpiresAtUtc claimTokenHash connectionGenerationAtUtc contractVersion createdAt customerId estimateAstHash estimateAstSnapshot estimateRequestId failedAtUtc id invoiceId invoiceRequestId invoiceVersion lastAttemptAtUtc lastFailureCode providerEstimateId providerEstimateSyncToken providerEstimateUpdatedAtUtc providerRealmId providerSubtotal providerTax providerTotal quickBooksConnectionId requestedByTenantUserId reviewBindingDigest reviewRevision reviewedAtUtc reviewedByTenantUserId sourceHash sourceQuoteId sourceSnapshot status supersededAtUtc tenantId uncertainAtUtc updatedAt",
...
const MODEL_POLICIES = {
  ...
  FollowUpTemplate: { defaultClassification: "C1_BUSINESS_INTERNAL", tenantScope: "required", purpose: "Versioned tenant automatic customer follow-up policy" },
  FollowUpTemplateStep: { defaultClassification: "C1_BUSINESS_INTERNAL", tenantScope: "required", purpose: "Immutable tenant follow-up cadence steps" },
  CustomerFollowUpSequence: { defaultClassification: "C1_BUSINESS_INTERNAL", tenantScope: "required", purpose: "Customer enrollment and follow-up lifecycle state" },
...
const FIELD_CLASSIFICATION_OVERRIDES = {
  ...
  "Customer.lastFollowUpAttemptAtUtc": "C1_BUSINESS_INTERNAL",
  "Customer.lastSuccessfulContactAtUtc": "C1_BUSINESS_INTERNAL",
  "Customer.lifecycleVersion": "C1_BUSINESS_INTERNAL",
  "Customer.lostAtUtc": "C1_BUSINESS_INTERNAL",
  "Customer.lostByTenantUserId": "C1_BUSINESS_INTERNAL",
  "Customer.lostReason": "C1_BUSINESS_INTERNAL",
  "Customer.lostReasonNotes": "C2_CUSTOMER_CONFIDENTIAL",
  "Customer.reopenedAtUtc": "C1_BUSINESS_INTERNAL",
  ...
  "ActivityTask.origin": "C1_BUSINESS_INTERNAL",
  "ActivityTask.followUpOutcome": "C1_BUSINESS_INTERNAL",
  "ActivityTask.followUpSequenceId": "C1_BUSINESS_INTERNAL",
  "ActivityTask.followUpStepNumber": "C1_BUSINESS_INTERNAL",
