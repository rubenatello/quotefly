...
const REVIEWED_SCHEMA_FIELD_TEXT = {
  ...
  Invoice: "amountPaid archivedAtUtc balanceDue createdAt currency customerId deletedAtUtc documentLocale dueAtUtc id invoiceNumber issuedAtUtc jobId paidAtUtc paymentStatus scopeSnapshot sentAtUtc sourceQuoteId status subtotalAmount taxAmount tenantId titleSnapshot totalAmount updatedAt version voidedAtUtc",
  InvoicePayment: "amount createdAt currency deletedAtUtc failedAtUtc failureCode id invoiceId paidAtUtc provider providerInvoiceId providerPaymentId receiptUrl refundedAtUtc status tenantId updatedAt",
  ...
  QuickBooksInvoiceOperation: "archivedAtUtc attemptCount claimExpiresAtUtc claimTokenHash commandKeyHash createdAt failedAtUtc id invoiceId lastAttemptAtUtc lastFailureCode lastReconciledAtUtc payloadHash processingStartedAtUtc providerDocNumber providerInvoiceId providerRealmId providerRequestId quickBooksConnectionId reconciliationCount requestedByTenantUserId status succeededAtUtc tenantId updatedAt",
