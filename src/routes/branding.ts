...
const BusinessProfileSchema = z
  .object({
    ...
    quoteMessageTemplate: nullableTrimmedStringSchema(4000),
      ...
      const result = await app.prisma.$transaction(async (tx) => {
        ...
        const branding = await tx.tenantBranding.upsert({
          ...
          create: {
            ...
            hideQuoteFlyAttribution: payload.hideQuoteFlyAttribution,
            primaryColor: payload.primaryColor,
            templateId: payload.templateId,
            businessEmail: businessProfile.businessEmail ?? null,
            businessPhone: businessProfile.businessPhone ?? null,
            quoteMessageTemplate: businessProfile.quoteMessageTemplate ?? null,
