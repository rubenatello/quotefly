  ...
  if (path === "/") {
    return {
      ...
      "@graph": [
        ...
        {
          "@type": "WebPage",
          "@id": `${PUBLIC_SITE_URL}/#page`,
          name: route.heading,
          description: route.description,
          url: canonical,
          isPartOf: { "@id": `${PUBLIC_SITE_URL}/#website` },
          about: { "@id": `${PUBLIC_SITE_URL}/#software` },
          primaryImageOfPage: { "@id": `${PUBLIC_SITE_URL}/#primaryimage` },
        },
        {
          "@type": "ImageObject",
          "@id": `${PUBLIC_SITE_URL}/#primaryimage`,
          url: PUBLIC_OG_IMAGE_URL,
          contentUrl: PUBLIC_OG_IMAGE_URL,
          width: 1200,
          height: 630,
          caption: "QuoteFly contractor quoting workflow shown on a mobile device.",
        },
