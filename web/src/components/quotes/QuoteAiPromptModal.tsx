          ...
          {loading ? (
            <div className="rounded-2xl border border-[color:rgba(47,111,214,0.16)] bg-[color:rgba(47,111,214,0.05)] px-4 py-4">
              ...
              <div className="mt-3 flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                ...
                <p className="text-sm text-slate-600">Reading prompt, checking customer context, matching saved jobs, reviewing similar quotes, and preparing the quote sheet.</p>
              </div>
            </div>
          ) : null}
        </ModalBody>
