...
const DEFAULT_CODE_KEYS: Readonly<Record<string, string>> = {
  ...
  FOLLOW_UP_OUTCOME_REQUIRED: "apiErrors.followUpOutcomeRequired",
  FOLLOW_UP_TASK_IMMUTABLE: "apiErrors.followUpTaskImmutable",
  FOLLOW_UP_OUTCOME_NOT_APPLICABLE: "apiErrors.followUpOutcomeNotApplicable",
  FOLLOW_UP_SETTINGS_STALE_VERSION: "apiErrors.followUpSettingsStale",
  ...
  CUSTOMER_REOPEN_REQUIRED: "apiErrors.customerReopenRequired",
  ...
  QUICKBOOKS_CUSTOM_NUMBERING_REQUIRED: "invoices.quickBooks.customNumberingRequired",
  QUICKBOOKS_NUMBERING_PREFLIGHT_INVALID: "invoices.quickBooks.numberingPreflightInvalid",
  QUICKBOOKS_NUMBERING_PREFLIGHT_UNAVAILABLE: "invoices.quickBooks.numberingPreflightUnavailable",
  QUICKBOOKS_DOC_NUMBER_COLLISION: "invoices.quickBooks.docNumberCollision",
