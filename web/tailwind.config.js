  ...
  theme: {
    extend: {
      colors: {
        ...
        "qf-action": "var(--qf-action-primary)",
        "qf-action-hover": "var(--qf-action-primary-hover)",
        "qf-action-secondary": "var(--qf-action-secondary)",
        "qf-interactive-hover": "var(--qf-interactive-hover)",
        "qf-interactive-active": "var(--qf-interactive-active)",
        "qf-selected": "var(--qf-selected)",
        "qf-success": "var(--qf-success-text)",
        "qf-warning": "var(--qf-warning-text)",
        "qf-danger": "var(--qf-danger-text)",
        "qf-info": "var(--qf-info-text)",
      },
      fontFamily: {
